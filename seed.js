...
const seedData = async () => {
  try {
    await mongoose.connect(
      "mongodb+srv://vvicky89864_db_user:3ZqmPUa8s2DRNP5t@chef.d1xnumn.mongodb.net/ChefHire",
    );
    ...
    const job1 = new Job({
      ...
      description:
        "Looking for experienced Head Chef specialized in North Indian curry and tandoor.",
      requirements: [
        "10+ years experience",
        "Team management",
        "Menu planning",
